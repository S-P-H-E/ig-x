    ...
    return (
        <div className="flex flex-col justify-center items-center mx-auto w-fit h-dvh">
            <div className="w-md flex flex-col items-center justify-center">
                ...
                <p className="text-muted-foreground text-sm text-center w-sm">This creates a new workflow and you will be navigated to a page where you can begin the workflow.</p>
                        ...
                        <div className="flex items-center justify-between border-2 border-border px-4 py-2 rounded-2xl w-full">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">{selectedFileSize} B</p>
                                </div>
                            </div>
                        </div>
                    )}
